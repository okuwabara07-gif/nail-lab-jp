...
const SITE_NAME = 'ネイルLAB';
const TOPIC = 'ネイル用品・ジェルネイル・マニキュア';
const CRITERIA = '発色・持続力・使いやすさ・コスパ・種類';
const A8_PRODUCT_NAME = 'ミチネイル';
const A8_PRODUCT_URL = 'https://px.a8.net/svt/ejp?a8mat=4AZR8U+FZBGTE+4LV8+BWGDT';
const A8_PRODUCT_DESC = 'プロ品質のネイルが自宅で';
