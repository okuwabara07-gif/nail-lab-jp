  ...
  return (
    <main style={{fontFamily:'sans-serif',maxWidth:'900px',margin:'0 auto',padding:'2rem'}}>
      ...
      <div style={{margin:'2rem 0',padding:'1.25rem',background:'linear-gradient(135deg,#faf7ff,#f5eeff)',borderRadius:'16px',border:'1.5px solid #e8d4ff'}}>
        ...
        <a href="https://px.a8.net/svt/ejp?a8mat=4AZR8U+D8W8C2+34VM+25EKCY" target="_blank" rel="noopener noreferrer sponsored"
          ...
          <div style={{width:'8px',height:'8px',borderRadius:'50%',background:'#FF69B4',flexShrink:0}}></div>
          <div>
            <div style={{fontSize:'0.8rem',fontWeight:700,color:'#333'}}>ミチネイル</div>
            <div style={{fontSize:'0.7rem',color:'#888'}}>プロネイリスト制作</div>
          </div>
          <span style={{marginLeft:'auto',fontSize:'0.75rem',color:'#FF69B4',fontWeight:700}}>→ 詳しく見る</span>
        </a>
      </div>
